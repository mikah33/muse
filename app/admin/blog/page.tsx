    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
          ...
          <Link
            href="/admin/blog/new"
            className="px-4 md:px-6 py-2 md:py-3 bg-black text-white text-xs md:text-sm tracking-wider hover:bg-gray-800 transition-colors whitespace-nowrap"
          >
            CREATE NEW POST
          </Link>
        </div>
        ...
        {!posts || posts.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-8 md:p-12 text-center">
            ...
            <Link
              href="/admin/blog/new"
              className="inline-block px-6 py-3 bg-black text-white tracking-wider hover:bg-gray-800 transition-colors"
            >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4 mb-2">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        {post.published ? (
                          <span className="px-2 md:px-3 py-1 bg-black text-white text-xs rounded-full">
                            Published
                          </span>
                        ) : (
                          <span className="px-2 md:px-3 py-1 bg-gray-200 text-gray-700 text-xs rounded-full">
                            Draft
                          </span>
                        )}
                      </div>
